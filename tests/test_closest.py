...
@Parametrization.case(
    ...
    expected_results_file=str(
        ASSET_DIR / "fixtures/closest/closest_expected_results.pgl"
    ),
)
@Parametrization.case(
    name="aAnnots",
    ...
    bAnnots=False,
    expected_results_file=str(
        ASSET_DIR / "fixtures/closest/closest_expected_results.aA.pgl"
    ),
)
@Parametrization.case(
    name="bAnnots",
    ...
    bAnnots=True,
    expected_results_file=str(
        ASSET_DIR / "fixtures/closest/closest_expected_results.bA.pgl"
    ),
)
@Parametrization.case(
    name="bothAnnots",
    ...
    bAnnots=True,
    expected_results_file=str(
        ASSET_DIR / "fixtures/closest/closest_expected_results.aA.bA.pgl"
    ),
)
