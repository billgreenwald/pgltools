...
from ..Module.PyGLtools.subtract import subtract2D
...
@Parametrization.case(
    ...
    a_pgl_file=str(ASSET_DIR / "fixtures/file.A.sorted.annotated.pgl"),
    b_pgl_file=str(ASSET_DIR / "fixtures/file.B.sorted.annotated.pgl"),
    expected_results_file=str(
        ASSET_DIR / "fixtures/subtract/subtract_expected_results.sub_b_from_a.pgl"
    ),
)
@Parametrization.case(
    name="subtract_a_from_b",
    a_pgl_file=str(ASSET_DIR / "fixtures/file.B.sorted.annotated.pgl"),
    b_pgl_file=str(ASSET_DIR / "fixtures/file.A.sorted.annotated.pgl"),
    expected_results_file=str(
        ASSET_DIR / "fixtures/subtract/subtract_expected_results.sub_a_from_b.pgl"
    ),
)
