...
from ..Module.PyGLtools.juicebox import juicebox
...
@Parametrization.case(
    ...
    expected_results_file=str(
        ASSET_DIR / "fixtures/juicebox/juicebox_expected_results.txt"
    ),
)
@Parametrization.case(
    name="baseline",
    ...
    C=0,
    expected_results_file=str(
        ASSET_DIR / "fixtures/juicebox/juicebox_expected_results.N7.txt"
    ),
)
@Parametrization.case(
    name="baseline",
    ...
    C=7,
    expected_results_file=str(
        ASSET_DIR / "fixtures/juicebox/juicebox_expected_results.C7.txt"
    ),
)
