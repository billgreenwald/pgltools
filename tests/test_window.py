...
@Parametrization.case(
    name="window1",
    window1="chr10:550000-570000",
    window2="%#$",
    expected_results_file=str(
        ASSET_DIR
        / "fixtures/window/window_expected_results.window1_chr10_550000_570000.pgl"
    ),
)
@Parametrization.case(
    name="window2",
    ...
    window2="chr10",
    expected_results_file=str(
        ASSET_DIR / "fixtures/window/window_expected_results.window2_chr10.pgl"
    ),
)
@Parametrization.case(
    name="both_windows",
    ...
    expected_results_file=str(
        ASSET_DIR
        / "fixtures/window/window_expected_results.window1_chr10_550000_570000.window2_chr10.pgl"
    ),
)
